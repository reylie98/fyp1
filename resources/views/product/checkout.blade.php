				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
                        <h2>Bill to</h2>
                            ...
                            <div class="form-group">
                                <input type="text" id="billinumber" name="billinumber" placeholder="Billing Mobile Number" class="form-control"/>
                            </div>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						<h2>Ship To</h2>
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Shipping Mobile Number" class="form-control"/>
                            </div>
