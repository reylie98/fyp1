            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  <li id="user-Alex" class="online"><a href=""><img alt="" src="{{asset('images/Backendimages/demo/av1.jpg')}}" /> <span>Alex</span></a></li>
                  <li id="user-Linda"><a href=""><img alt="" src="{{asset('images/Backendimages/demo/av2.jpg')}}" /> <span>Linda</span></a></li>
                  <li id="user-John" class="online new"><a href=""><img alt="" src="{{asset('images/Backendimages/demo/av3.jpg')}}" /> <span>John</span></a><span class="msg-count badge badge-info">3</span></li>
                  <li id="user-Mark" class="online"><a href=""><img alt="" src="{{asset('images/Backendimages/demo/av4.jpg')}}" /> <span>Mark</span></a></li>
                  <li id="user-Maxi" class="online"><a href=""><img alt="" src="{{asset('images/Backendimages/demo/av5.jpg')}}" /> <span>Maxi</span></a></li>
                </ul>
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content tab-content">
            ...
            <div id="tab3" class="tab-pane">
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment. </p>
              <img src="{{asset('images/Backendimages/demo/demo-image3.jpg')}}" alt="demo-image"/></div>
          </div>
        </div>
      </div>
    </div>
