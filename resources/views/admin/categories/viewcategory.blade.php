            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td>{{ $category->url }}</td>
                    <td class="centre"><a href="{{url('/admin/editcategory/'.$category->id) }}" class="btn btn-primary btn-mini">Edit</a> <a id="deleteCat" href="{{url('/admin/deletecategory/'.$category->id) }}" class="btn btn-danger btn-mini">Delete</a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
