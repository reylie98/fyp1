              ...
              <tbody>
                ...
                <tr class="gradeX">
                    ...
                    @endif
                      ...
                      <a href="{{url('/admin/addatributes/'.$product->id) }}" class="btn btn-success btn-mini">Add</a> <a href="{{url('/admin/addimages/'.$product->id) }}" class="btn btn-info btn-mini">images</a>
                    </td>
                </tr>   
